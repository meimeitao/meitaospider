...
casper.then(function() {
    ...
    var retColor = this.evaluate(function() {
        ...
        var colorOptions = document.querySelectorAll("select.super-attribute-select[data-label='Color'] option");

        var select = document.querySelector("select.super-attribute-select[data-label='Color']");
        select.selectedIndex = colorOptions.length - 1;
    ...
    var retSize = this.evaluate(function() {
        ...
        var sizeOptions = document.querySelectorAll("select.super-attribute-select[data-label='Size'] option");
